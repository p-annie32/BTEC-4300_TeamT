...
def makeblastdb(dbname,dbseqs):
	...
	Arguments:
	dbname: name for the blast database
	dbseqs: name of the file makeblastdb will use to build database.
...
def run_blastp(query,dbname,outdir):
	'''Run blastp command. The query is predicted proteins or other proteins and the database is the refseq database, unless a different databse is supplied.
